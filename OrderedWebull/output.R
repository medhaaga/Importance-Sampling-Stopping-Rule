...
pdf(file = "Out/ISestimator_corrplot_H1.pdf", height=5, width =5)
corrplot(cov2cor(emp.var1), method = "circle")
dev.off()
pdf(file = "Out/ISestimator_corrplot_H2.pdf", height=5, width =5)
...
load(file = "Out/ESSvsSampSize_objects_kong_uni_mult.Rdata")
...
load(file = "Out/ESS_eps_H1_H2.Rdata")
