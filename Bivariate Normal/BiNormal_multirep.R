...
for(i in 1:3)
{
  ...
  legend("topleft", legend = c("Target variance", "Proposal variance", "UIS variance", "SNIS variance"), bty = 'n', cex=.9, col = c("black", "blue", "red", "orange"), lty=c(2,2,1,1), lwd=2)
  dev.off()
}
...
for (t in 1:3)
{
  ...
  if(t==1)
    legend("topright", legend = c("UIS", "SNIS"), bty = 'n', cex=1, col = c("red", "orange"), lwd=2) else
      legend("topleft", legend = c("UIS", "SNIS"), bty = 'n', cex=1, col = c("red", "orange"), lwd=2)
